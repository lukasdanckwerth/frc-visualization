...
function dataset(name, value) {
  return { label: name, group: name, data: data(tracks, value) };
}
...
tokensF.group = "Tokens";
tokensM.group = "Tokens";
tokensG.group = "Tokens";
...
tokensF.about =
  "Amount of the tokens and the types of the corpus grouped by female, male and group artists.";
...
datasetFemale.group = "All";
datasetMale.group = "All";
datasetGroup.group = "All";
...
fileAccess.writeJSON(
  ...
  "year.to.tracks.grouped.json"
);

delete datasetFemale.group;
delete datasetMale.group;
delete datasetGroup.group;
...
datasetFemale.group = "Artists per Tracks";
datasetMale.group = "Artists per Tracks";
datasetGroup.group = "Artists per Tracks";
...
fileAccess.writeJSON(
  [datasetFemale, datasetMale, datasetGroup],
  "year.to.artists.per.tracks.grouped.json"
);
